-- Oracle DDL Statements for Stellar Business Tables
-- Converted from MariaDB Schema
-- Focus: Business operations, bookings, customers, and related lookup tables
...
CREATE TABLE DW_STELLAR_LOCATIONS (
...
CREATE TABLE DW_STELLAR_CUSTOMERS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    USER_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_BOOKINGS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_BOOKING_BOATS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_BOOKING_PAYMENTS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    BOOKING_ID NUMBER(10,0),
    CUSTOMER_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_STYLE_GROUPS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_STYLES (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_STYLE_BOATS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    STYLE_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_CUSTOMER_BOATS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    CUSTOMER_ID NUMBER(10,0),
    SLIP_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_SEASONS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_SEASON_DATES (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_STYLE_HOURLY_PRICES (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    STYLE_ID NUMBER(10,0),
    SEASON_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_STYLE_TIMES (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    STYLE_ID NUMBER(10,0),
    SEASON_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_STYLE_PRICES (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    TIME_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_ACCESSORIES (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_ACCESSORY_OPTIONS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_ACCESSORY_TIERS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    ACCESSORY_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_BOOKING_ACCESSORIES (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    BOOKING_ID NUMBER(10,0),
    ACCESSORY_ID NUMBER(10,0),
    QTY NUMBER(3,0),
...
CREATE TABLE DW_STELLAR_CLUB_TIERS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_COUPONS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
    CODE NVARCHAR2(191),
...
CREATE TABLE DW_STELLAR_POS_ITEMS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
    SKU NVARCHAR2(191),
...
CREATE TABLE DW_STELLAR_POS_SALES (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
    ADMIN_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_FUEL_SALES (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
    ADMIN_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_WAITLISTS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_CLOSED_DATES (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
    CLOSED_DATE DATE,
...
CREATE TABLE DW_STELLAR_HOLIDAYS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    LOCATION_ID NUMBER(10,0),
    HOLIDAY_DATE DATE,
    DW_LAST_INSERTED TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE DW_STELLAR_BLACKLISTS (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
    FIRST_NAME NVARCHAR2(191),
...
CREATE TABLE DW_STELLAR_CATEGORIES (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
...
CREATE TABLE DW_STELLAR_AMENITIES (
    DW_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID NUMBER(10,0),
    LOCATION_ID NUMBER(10,0),
